...
Utilise quand l'annonce backend porte un `link_url`. Accessible : corps dans un
wx.TextCtrl lecture seule (lu par NVDA), focus dessus, bouton « Ouvrir le lien »
qui ouvre l'URL et declenche le suivi /api/announce/click via on_link.
"""
import webbrowser
...
class AnnouncementDialog(wx.Dialog):
    def __init__(self, parent, title, body, link_label="", link_url="", on_link=None):
        ...
        self._on_link = on_link  # callable() — declenche /click cote backend
